...
### HCM001
- rating: 4.8
- comment: Very clean room, friendly staff, good breakfast.
- rating: 4.6
- comment: Great location near downtown, comfortable bed.
- rating: 4.2
- comment: Nice service but the elevator was slow.
- rating: 4.7
- comment: Excellent value and quiet at night.

### HAN002
- rating: 3.9
- comment: Convenient location but room felt small.
- rating: 4.1
- comment: Helpful front desk and quick check-in.
- rating: 3.7
- comment: Breakfast was average, wifi was unstable.
- rating: 4.0
- comment: Good for business trips, clean and safe.

### DAD003
- rating: 4.9
- comment: Amazing sea view and super clean facilities.
- rating: 4.7
- comment: Staff were excellent, spa service was perfect.
- rating: 4.8
- comment: Large room, great breakfast, family friendly.
